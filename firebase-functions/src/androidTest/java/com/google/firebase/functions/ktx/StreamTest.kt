...
class StreamTest {
    ...
    fun setUp() {
        ...
        httpsCallableOptions =
            HttpsCallableOptions.Builder().setLimitedUseAppCheckTokens(false).build()
...
//        `when`(mockFunctionsClient.stream(anyString(), any(), any(), any())).thenReturn(Tasks.forResult(null))
//
//        // Act
...
//        // Arrange
//        `when`(mockFunctionsClient.stream(anyString(), isNull(), any(), any())).thenReturn(Tasks.forResult(null))
//
//        // Act
...
//        // Assert
//        assertThat(result.isSuccessful).isTrue()
//        verify(mockFunctionsClient).stream(eq("testFunction"), isNull(), eq(dummyOptions), eq(mockListener))
//    }
//
//    @Test
...
//        )
//
//        `when`(mockFunctionsClient.stream(any(URL::class.java), any(), any(), any())).thenReturn(Tasks.forResult(null))
//
//        // Act
...
//        // Assert
//        assertThat(result.isSuccessful).isTrue()
//        verify(mockFunctionsClient).stream(eq(testUrl), eq(testData), eq(dummyOptions), eq(mockListener))
//    }
//
//    @Test
...
//        )
//
//        `when`(mockFunctionsClient.stream(any(URL::class.java), isNull(), any(), any())).thenReturn(Tasks.forResult(null))
//
//        // Act
...
//        // Assert
//        assertThat(result.isSuccessful).isTrue()
//        verify(mockFunctionsClient).stream(eq(testUrl), isNull(), eq(dummyOptions), eq(mockListener))
//    }
//
//    @Test
...
//        `when`(mockFunctionsClient.stream(anyString(), any(), any(), any())).thenReturn(Tasks.forException(exception))
//
//        // Act
...
//        verify(mockFunctionsClient).stream(eq("testFunction"), eq(testData), eq(dummyOptions), eq(mockListener))
//    }
    ...
    fun streamEmitsEvents() {
        ...
        val listener = object : SSETaskListener {
        ...
        // Assert
        assertThat(receivedEvents).containsAtLeast(
            "Event 1", "Event 2", "Complete: Stream complete"
        )
